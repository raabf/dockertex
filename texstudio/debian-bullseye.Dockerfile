FROM raabf/latex-versions:bullseye
...
RUN wget -O texstudio.deb "http://download.opensuse.org/repositories/home:/jsundermeyer/Debian_11/amd64/texstudio_${TEXSTUDIO_VERSION}_amd64.deb" && \
