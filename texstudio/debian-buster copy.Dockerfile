FROM raabf/latex-versions:bookworm
...
# kde-style-breeze: for the modern KDE Plasma look (configurable in texstudio options)
...
RUN wget -O texstudio.deb "http://download.opensuse.org/repositories/home:/jsundermeyer/Debian_Testing/amd64/texstudio_${TEXSTUDIO_VERSION}_amd64.deb" && \
