...
RUN wget -O texstudio.deb "http://download.opensuse.org/repositories/home:/jsundermeyer/xUbuntu_16.04/amd64/texstudio_${TEXSTUDIO_VERSION}_amd64.deb" && \
